...
const pgHost = process.env.PGHOST || process.env.SUPABASE_DB_HOST || 'wazadoxxx\'s Project';
const pgUser = process.env.PGUSER || process.env.SUPABASE_DB_USER || 'postgres';
const pgDatabase = process.env.PGDATABASE || process.env.SUPABASE_DB_NAME || 'postgres';
const pgPassword = process.env.PGPASSWORD || process.env.SUPABASE_DB_PASSWORD || 'xbjty2N+7-YvV7W';
const pgPort = Number(process.env.PGPORT || process.env.SUPABASE_DB_PORT || 5432);
const hasConfiguredPostgres = ![
  'wazadoxxx\'s Project',
  'xbjty2N+7-YvV7W'
].includes(pgHost) && ![
  'wazadoxxx\'s Project',
...
db.pgPool = pgPool;
db.hasConfiguredPostgres = hasConfiguredPostgres;
